...
This guide is based on common usage patterns in the checked-out repo at `/data/workspace/code/oss/effect-smol`.

Key source areas:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/Effect.ts`
- `/data/workspace/code/oss/effect-smol/packages/tools/`
- `/data/workspace/code/oss/effect-smol/packages/platform-*`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/`
- `/data/workspace/code/oss/effect-smol/packages/vitest/`
...
- `/data/workspace/code/oss/effect-smol/packages/tools/utils/src/Codegen.ts`
- `/data/workspace/code/oss/effect-smol/packages/tools/openapi-generator/src/OpenApiPatch.ts`
...
- `/data/workspace/code/oss/effect-smol/packages/tools/openapi-generator/src/OpenApiGenerator.ts`
...
- `/data/workspace/code/oss/effect-smol/packages/tools/utils/src/bin.ts`
- `/data/workspace/code/oss/effect-smol/packages/tools/openapi-generator/test/`
...
- `/data/workspace/code/oss/effect-smol/packages/platform-node/`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/NodeSdk.ts`
...
- `/data/workspace/code/oss/effect-smol/packages/platform-node/`
- `/data/workspace/code/oss/effect-smol/packages/vitest/src/index.ts`
