...
This guide is based on the checked-out Schema module and common repo usage in `/data/workspace/code/oss/effect-smol`.

Key source files:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schema.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/SchemaTransformation.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/SchemaGetter.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/SchemaIssue.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/JsonSchema.ts`

Representative repo usage:

- `/data/workspace/code/oss/effect-smol/packages/tools/ai-codegen/src/Config.ts`
- `/data/workspace/code/oss/effect-smol/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `/data/workspace/code/oss/effect-smol/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `/data/workspace/code/oss/effect-smol/packages/tools/openapi-generator/`
...
Important rule from the checked-out docs:
...
The checked-out docs explicitly note that `decodeTo` is curried and should be used with `pipe`.
...
The checked-out `Schema.ts` implements key renaming by mapping fields and using decode/encode transformations with renamed key maps.
...
Patterns visible in the checked-out repo:
...
- `/data/workspace/code/oss/effect-smol/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `/data/workspace/code/oss/effect-smol/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `/data/workspace/code/oss/effect-smol/packages/tools/openapi-generator/src/JsonSchemaGenerator.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schema.ts`
