...
This guide is based on the checked-out Effect SQL modules in `/data/workspace/code/oss/effect-smol`.

Key source files:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlClient.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/Migrator.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlResolver.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlSchema.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlModel.ts`
...
`SqlResolver` is one of the clearest examples of SQL and Schema integration in the checked-out repo.
...
Important behavior in the checked-out repo:
...
This matches the model used by the checked-out migrator implementation:
...
From the checked-out packages, this is implemented as `Layer.effectDiscard(run(options))`.
...
The checked-out SQL modules already integrate with spans and transaction context.
