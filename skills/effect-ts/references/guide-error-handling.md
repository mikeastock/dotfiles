...
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Data.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schema.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Cause.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Effect.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlError.ts`
...
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schema.ts`
- examples across `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/*`

Example shape from the checked-out repo:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/httpapi/HttpApiError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/workers/WorkerError.ts`
...
The checked-out repo uses schema-backed errors in places like SQL, RPC, sockets, and HTTP APIs.

Strong examples:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/socket/Socket.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/eventlog/EventLogMessage.ts`
...
This is a very common pattern in the checked-out repo.

Good examples:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/rpc/RpcClientError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/socket/Socket.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/workers/WorkerError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/persistence/Redis.ts`
...
- `Schema.Defect({ includeStack: true })` when the stack should be preserved in the schema contract
...
### `Schema.Defect()` and stack preservation
...
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schema.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/http/HttpClientError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/http/HttpServerError.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/socket/Socket.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/httpapi/HttpApiError.ts`
