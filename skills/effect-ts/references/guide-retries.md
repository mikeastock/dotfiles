...
This guide is based on retry patterns and `ExecutionPlan` usage in the checked-out Effect repo.

Key source files:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/Effect.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schedule.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/ExecutionPlan.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/test/Effect.test.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/test/ExecutionPlan.test.ts`

Representative repo usage:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/workflow/Activity.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/workflow/WorkflowEngine.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/rpc/RpcClient.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/observability/OtlpExporter.ts`
- `/data/workspace/code/oss/effect-smol/packages/vitest/src/internal/internal.ts`
...
The checked-out tests show several important supported forms.
...
The checked-out repo repeatedly uses these patterns:
...
The checked-out tests focus on `Stream.withExecutionPlan` and demonstrate:
...
An execution plan's `captureRequirements` effect converts it into a plan whose requirements are satisfied from the current context.

Use `yield* plan.captureRequirements` when the plan should be frozen with the current environment before being applied later.
