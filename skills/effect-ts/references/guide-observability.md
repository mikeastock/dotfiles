...
This guide is based on the checked-out Effect source in `/data/workspace/code/oss/effect-smol`.

Key source files:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/Effect.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Tracer.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Logger.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Metric.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/NodeSdk.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/OtelTracer.ts`
...
The checked-out Effect repo itself uses `fnUntraced` in a number of low-level internals and integration helpers. That does not make it the default recommendation for downstream application or business code.
...
The checked-out repo provides `@effect/opentelemetry` layers such as:
...
The checked-out repo includes a real integration layer for the OpenTelemetry JavaScript ecosystem in `@effect/opentelemetry`.
...
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/NodeSdk.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/OtelTracer.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/OtelMetrics.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/OtelLogger.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/Resource.ts`
- `/data/workspace/code/oss/effect-smol/packages/opentelemetry/src/WebSdk.ts`
...
From the checked-out source, it accepts a configuration that can include:
...
Important integration points from the checked-out source:
...
The `OtelMetrics` module connects Effect metrics to OpenTelemetry JS metric readers.

Important details from the checked-out implementation:

- `OtelMetrics.layer(...)` registers a producer against one or more metric readers
...
- `OtelLogger.layer({ mergeWithExisting })` can merge with or replace existing application loggers
...
The checked-out layers use scoped acquisition and release for tracer providers, metric readers, and logger providers.
...
The checked-out `OtelTracer` module provides:
