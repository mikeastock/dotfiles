...
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Context.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Layer.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Effect.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/ManagedRuntime.ts`
...
This matches the checked-out repo's current style.
...
- it matches the patterns used across `/data/workspace/code/oss/effect-smol`
...
class UserRepo extends Context.Service<UserRepo>()("UserRepo", {
  make: Effect.succeed({
    getById: Effect.fn("UserRepo.getById")(function*(id: string) {
      return yield* UserRepoError.make({ message: `User ${id} not found` })
    })
  })
}) {}
```
...
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Layer.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/ManagedRuntime.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/Stream.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/sql/SqlClient.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/persistence/Persistence.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/rpc/RpcSerialization.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/src/unstable/reactivity/Reactivity.ts`
