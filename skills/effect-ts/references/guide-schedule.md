...
This guide is based on the checked-out `Schedule` module and its usage across `/data/workspace/code/oss/effect-smol`.

Key source files:

- `/data/workspace/code/oss/effect-smol/packages/effect/src/Schedule.ts`
- `/data/workspace/code/oss/effect-smol/packages/effect/test/Schedule.test.ts`
...
The most common patterns in the checked-out repo are:
