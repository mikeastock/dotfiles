...
6. Consult [opencode v2](https://github.com/anomalyco/opencode/tree/v2) or [executor](https://github.com/UsefulSoftwareCo/executor) only when the target repository lacks a useful precedent. Use them for patterns, verify their Effect version, and never treat them as API authority.
