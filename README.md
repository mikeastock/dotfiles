...
- `effect-ts` — concise Effect v4 workflow backed by Effect's `LLMS.md` plus shared effect-smol, opencode, and executor checkouts, with opencode guidance targeting v2
