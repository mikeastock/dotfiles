...
type ProviderArt = {
  ...
  label: string;
  viewBox: string;
  /** Drawn in order and filled with `currentColor`. */
  paths: { d: string; fillOpacity?: number }[];
...
const PROVIDER_ART: Record<string, ProviderArt> = {
  ...
  "acp-opencode": {
    ...
    paths: [
      // The lighter inner square is part of the mark, not a rendering artifact.
      { d: "M180 240H60V120H180V240Z", fillOpacity: 0.45 },
